...
For daily commit reports, use `shipbrief run --today`, then summarize the generated TOON in human language before sending. Use `--format json --full` only when complete commit bodies are needed.
